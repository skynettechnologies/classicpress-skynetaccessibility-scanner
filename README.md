...
### Key Benefits for ClassicPress Users

- Works directly within the ClassicPress ecosystem
...
- Scales across multiple ClassicPress websites and projects
...
## How does ClassicPress accessibility scanning and monitoring work?
...
### Prerequisites
- ClassicPress version 2.7.0
- Supported version from 2.2 to 2.7.0
- PHP Version 8.0

## Installation

1. Load via installer or unzip the zip file in the `/wp-content/plugins/` directory, the folder must be called "skynetaccessibility-scanner".
2. Log into the ClassicPress admin panel.
3. Go to **Plugins > List**, and activate the SkynetAccessibility Scanner plugin.
...
https://classicpress.skynettechnologies.us/
